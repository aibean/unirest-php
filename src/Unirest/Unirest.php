...
class Unirest
{
    ...
    {
        return self::prepare(Method::GET, $url, $parameters, $headers, $username, $password);
    }
    ...
    {
        return self::prepare(Method::HEAD, $url, $parameters, $headers, $username, $password);
    }
    ...
    {
        return self::prepare(Method::OPTIONS, $url, $parameters, $headers, $username, $password);
    }
    ...
    {
        return self::prepare(Method::CONNECT, $url, $parameters, $headers, $username, $password);
    }
    ...
    {
        return self::prepare(Method::POST, $url, $body, $headers, $username, $password);
    }
    ...
    {
        return self::prepare(Method::DELETE, $url, $body, $headers, $username, $password);
    }
    ...
    {
        return self::prepare(Method::PUT, $url, $body, $headers, $username, $password);
    }
    ...
    {
        return self::prepare(Method::PATCH, $url, $body, $headers, $username, $password);
    }
    ...
    {
        return self::prepare(Method::TRACE, $url, $body, $headers, $username, $password);
    }
    ...
    public static function getResponse($request)
    {
        ...
        if ($request->method !== Method::GET) {
            curl_setopt(self::$handle, CURLOPT_CUSTOMREQUEST, $request->method);

            if (is_array($request->body) || $request->body instanceof \Traversable) {
                curl_setopt(self::$handle, CURLOPT_POSTFIELDS, self::buildHTTPCurlQuery($request->body));
            } else {
                curl_setopt(self::$handle, CURLOPT_POSTFIELDS, $request->body);
            }
            ...
            $request->url .= urldecode(http_build_query(self::buildHTTPCurlQuery($request->body)));
        }
